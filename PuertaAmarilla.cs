...
public class PuertaAmarilla : MonoBehaviour
{
    ...
    {
        // Verifica si el objeto que colisiona es el jugador y si tiene la tarjeta amarilla
        if (other.CompareTag("Player") && tarjetasManager.TarjetaAmarilla)
        {
