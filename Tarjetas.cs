...
{
    public GameObject keyImage; // Imagen que representa la tarjeta amarilla en la interfaz
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.CompareTag("Player"))
        {
            ...
            tarjetasManager.TarjetaAmarilla = true; // Marca la tarjeta amarilla como recogida
    ...
    private IEnumerator Aviso() // Coroutine que maneja la duración del aviso
    {
        ...
        Destroy(gameObject); // Destruye el objeto de la tarjeta amarilla
    }
}
