...
public class TarjetaRoja : MonoBehaviour
{
    public GameObject keyImage; // Imagen que representa la tarjeta roja en la interfaz
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.CompareTag("Player"))
        {
            ...
            tarjetasManager.TarjetaRoja = true; // Marca la tarjeta roja como recogida
    ...
    private IEnumerator Aviso() // Coroutine que maneja la duración del aviso
    {
        ...
        Destroy(gameObject); // Destruye el objeto de la tarjeta roja
    }
}
